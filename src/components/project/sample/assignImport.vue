  ...
  <div id="updateAssign">
    <div class="upload">
      ...
      <div class="nav" v-if="showNav">
        <div class="item"><span>成功上传 {{ successUpload }} 条记录，{{ no }} 个样本无效<span class="color pointer" @click.prevent="downloadExcel('err')"> (下载无效名单) </span></span></div>
      ...
      <div class="addBtn" v-permission="{projectId: $route.query.id, permissionId: Constant.RS_SAMPLE_ASSIGN_ADMIN}">
        ...
        <el-button type='primary' size='mini' class="mini" @click="updateSave"><span>确定批量添加</span></el-button></div>
    </div>
  </div>
</template>
